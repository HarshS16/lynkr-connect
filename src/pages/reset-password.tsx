...
export default function ResetPassword() {
  ...
  // Extract tokens from the URL hash and set the session
  useEffect(() => {
    ...
    const restoreSession = async () => {
      if (accessToken && refreshToken) {
        ...
        // Clear the URL hash to make things look cleaner
        window.history.replaceState({}, document.title, window.location.pathname);
        setTokenLoaded(true);
      } else {
        toast({
          title: 'Invalid reset link',
          description: 'Missing token in the URL. Please request a new reset link.',
          variant: 'destructive',
        });
      }
    };
